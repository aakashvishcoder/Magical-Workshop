...
const PumpkinStewGame: React.FC = () => {
  ...
  return (
    <div className="text-center p-6 max-w-md w-full">
      ...
      <p className="text-fall-text/80 mb-6">Click when the bubble pops!</p>
      ...
      {status === 'failed' && (
        <div className="mt-4">
          <p className="text-red-600 font-medium mb-3">Stew burned! Try again.</p>
          <button
      ...
      {status === 'success' && (
        <div className="mt-4">
          <p className='text-green-600 font-bold animate-pulse'>✨ Delicious! Spell Tome unlocked!</p>
        </div>
      )}
    </div>
  );
